...
export const driverPreferences = pgTable('driver_preferences', {
  ...
  blacklistedZonesJson: jsonb('blacklisted_zones_json').$type<string[]>().notNull().default([]),
...
export const rideRequests = pgTable('ride_requests', {
  ...
  pickup: text('pickup').notNull().default('Unknown'),
  dropoff: text('dropoff').notNull().default('Unknown'),
  riderRating: doublePrecision('rider_rating').notNull().default(4.8),
  eta: text('eta').notNull().default('3 min'),
