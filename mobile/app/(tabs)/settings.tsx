    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingTop: topInset + 18, paddingBottom: bottomInset + 95 }}>
        ...
        <View style={[styles.identityCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <View style={styles.identityCopy}><Text style={[styles.identityName, { color: colors.foreground }]}>{driver.email || 'Not signed in'}</Text><Text style={[styles.identitySub, { color: colors.mutedForeground }]}>{isPro ? 'Radar Pro member' : 'Free plan'}</Text></View>
