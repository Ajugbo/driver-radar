...
import { cors, handleError, methodGuard, memoryPreferences, requireUser, type ApiRequest, type ApiResponse } from '../_lib/http';
...
export default async function handler(req: ApiRequest, res: ApiResponse) {
  ...
  try {
    ...
    // FIX: Removed demoRides fallback. If database is empty, result is empty array.
